...
function statistics() {
  return (
    <DashboardLayout activePage={"Statistics"}>
      <section
        className=" xl:mt-8 2xl:mt-20  gap-4 "
        // style={{ gridTemplateColumns: "2fr 1fr" }}
      >
        {" "}
        <div
          className={`border border-[#395251] mb-4 backdrop-blur-[2px] flex items-center space-x-60 pl-16  w-full bg-[#15191ddf] py-4 opacity-0 ${
            true ? "opacity-100" : ""
