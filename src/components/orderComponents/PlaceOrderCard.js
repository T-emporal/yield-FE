...
const PlaceOrderCard = () => {
  ...
  return (
    <div className="bg-[#15191D]  p-6 rounded-md w-full">
      <div className="flex items-center justify-between mb-2">
        <span className="text-xl font-bold text-white">Place Order</span>
        <span className="-rotate-45 flex items-center">
          <ArrowSmallRightIcon strokeWidth={3} className="w-3 h-3 text-white" />
          <ArrowSmallLeftIcon strokeWidth={3} className="w-3 h-3 text-white" />
        </span>
      </div>
          ...
          {tabs.map((tab) => (
            <a
              ...
              className={classNames(
                ...
                "whitespace-nowrap border-b-2 py-2 px-1 text-xl font-light uppercase"
              )}
